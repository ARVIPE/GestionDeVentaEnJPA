...
public class ventanaConcesionario extends JPanel {
	...
	public ventanaConcesionario() {
		...
		gbc_lblId.gridx = 1;
		gbc_lblId.gridy = 1;
		getRootPane().add(lblId, gbc_lblId);
		...
		getRootPane().add(textField, gbc_textField);
		...
		gbc_lblCif.gridx = 1;
		gbc_lblCif.gridy = 2;
		getRootPane().add(lblCif, gbc_lblCif);
		...
		getRootPane().add(textField_1, gbc_textField_1);
		...
		getRootPane().add(lblNombre, gbc_lblNombre);
		...
		getRootPane().add(textField_2, gbc_textField_2);
	...
	private void guardar () {
		...
		nuevoRegistro.setLocalidad(this.textField_3.getText());
	...
	private void cargarDatosActual () {
		if (this.actual != null) {
			...
			this.textField_3.setText(this.actual.getLocalidad());
		}
	}
